...
public class pageetudiant extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pageetudiant);
        ...
        if (currentUser != null) {
            ...
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Matieres");
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(pageetudiant.this, android.R.layout.simple_spinner_item, matieresList);
            ...
            validateButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(pageetudiant.this,matiereenseignantcsv.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        // Éventuellement, ajoutez du code ici en cas de sélection d'un élément dans le Spinner
    }

    @Override
    public void onNothingSelected(AdapterView<?> parent) {
        // Éventuellement, ajoutez du code ici en cas de non-sélection dans le Spinner
    }
}
